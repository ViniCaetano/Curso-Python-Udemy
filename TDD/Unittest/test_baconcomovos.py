...
class TestBaconComOvos(unittest.TestCase):
    ...
    def test_bacon_com_ovos_deve_retornar_bacon_com_ovos_se_entrada_for_multiplo_de_3_e_de_5(self):
    ...
    def test_bacon_com_ovos_deve_retornar_passar_fome_se_entrada_nao_for_multiplo_de_3_e_de_5(self):
        entradas = (1, 2, 4, 7, 8)
        saida = 'Passar fome'
